...
<div class="page-banner">
  <div class="page-banner__bg-image" style="background-image: url(<?php echo get_theme_file_uri( '/images/library-hero.jpg' ) ?>);"></div>
    <div class="page-banner__content container t-center c-white">
      ...
      <a href="<?php 
      // get_post_type_archive_link( 'program' ) return the URL => http://fictional-university/programs/
  ...
  <div class="full-width-split group">
    <div class="full-width-split__one">
      <div class="full-width-split__inner">
        ...
        <?php 
        // show the most recent event and hide the past event that has been occured
          $today = date('Ymd');
          $home_page_events =  new WP_Query( array(
            'posts_per_page' => 2, /// show all post when you put -1
            'post_type'      => 'event',
            'meta_key'       => 'event_date', // ACF field name: metakey sort it by event date
            'orderby'        => 'menu_value_num', // sorting numbers
            'order'          => 'ASC',
            'meta_query'     => array( // filter out past events
              array(
